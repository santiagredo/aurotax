    ...
    if (wage > 0) {
        ...
        if (income > 0 && expenses >= 0) {
            if (profit >= 0) {
                ...
                document.getElementById("selfEmploymentTax").innerHTML =
                    totalTaxPartOne;
                ...
                document.getElementById("totalTaxPartOne").value =
                    totalTaxPartOne;
                document.getElementById("deductionSelfEmpTax").value =
                    deductionSelfEmpTax;
                ...
                alert(
                    "Valide los valores ingresados. Recuerde que sus gastos no pueden ser mayor que sus ingresos. Si requiere ayuda presione el icono de chat"
                );
            ...
            alert(
                "El Ingreso Neto (Ingresos - Gastos) no puede ser  menor que cero para declarar impuestos. Valide los valores registrados, Si requiere ayuda presione el icono de chat"
            );
        }
    } else {
